...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Router = __webpack_require__(157);
	var UserProile = __webpack_require__(204);
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { className: 'col-md-4' },
	        React.createElement(UserProile, { username: username, bio: this.state.bio })
	      ),
	      React.createElement(
	        'div',
	        { className: 'col-md-4' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddNote = React.createClass({
	  ...
	  propTypes: {
	    username: React.PropTypes.string.isRequired,
	    addNote: React.PropTypes.string.isRequired
	  },
	  handleSubmit: function handleSubmit() {
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('input', { type: 'button', className: 'btn btn-default', value: 'Submit', onClick: this.handleSubmit })
	      )
	    );
	  }
	});
